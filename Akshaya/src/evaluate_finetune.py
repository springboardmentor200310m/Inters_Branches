...
BATCH_SIZE = 32
COLOR_MODE = "rgb"         # 🔥 Must be RGB

# -----------------------------
# LOAD MODEL
# -----------------------------
model = tf.keras.models.load_model(MODEL_PATH)
print("✅ Fine-tuned MobileNet model loaded successfully")
...
# -----------------------------
print("\n📊 Classification Report (Fine-Tuned MobileNet):\n")
...
sns.heatmap(
    ...
    annot=True,
    fmt="d",
    cmap="magma",   # 🔥 Same color style you wanted
